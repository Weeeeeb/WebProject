...
public class Date_Stamp {
	...
	/**
	 * 通过 本星期的 时间 算出  yyyy-MM-dd 形式的 日期
	 */
	public static String getYMDDates(String str){
		SimpleDateFormat sdf=new SimpleDateFormat("yyyy-MM-dd");
		Calendar ca = Calendar.getInstance();
		int da = Integer.parseInt(str);
		ca.setTime(new Date());
		ca.set(Calendar.DAY_OF_WEEK, da + 1);
		String res = sdf.format(ca.getTime());
		return res;
	}
